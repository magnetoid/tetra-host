...
describe("ConsoleNav context switch", () => {
  it("shows the global menu and no project name outside a project", () => {
    ...
    // project panel exists but its name heading is empty when not in a project
  ...
  it("swaps to the project menu (name + active Logs) inside a project", () => {
